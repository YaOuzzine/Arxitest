    ...
    <div class="h-full">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            ...
            <div class="group relative h-full">
                <div
                    class="absolute -inset-1 bg-gradient-to-r from-blue-600 to-cyan-500 rounded-2xl blur opacity-10 group-hover:opacity-20 transition duration-1000">
                </div>
                <div
                    class="integration-card relative h-full bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-200 dark:border-zinc-700 overflow-hidden transition-all duration-300 hover:-translate-y-2">
                    <div class="p-6">
                    ...
                    <div
                        class="px-6 py-4 bg-zinc-50/50 dark:bg-zinc-800/20 border-t border-zinc-200/50 dark:border-zinc-700 flex justify-between items-center">
                        @if ($jiraConnected)
                            <div class="flex items-center space-x-2">
                        ...
                        @else
                            ...
                            <a href="{{ route('integrations.jira.redirect') }}"
            ...
            <div class="group relative h-full">
                <div
                    class="absolute -inset-1 bg-gradient-to-r from-purple-600 to-fuchsia-500 rounded-2xl blur opacity-10 group-hover:opacity-20 transition duration-1000">
                </div>
                <div
                    class="integration-card relative h-full bg-white dark:bg-zinc-900 rounded-2xl border border-zinc-200 dark:border-zinc-700 overflow-hidden transition-all duration-300 hover:-translate-y-2">
                    <div class="p-6">
                        ...
                        <p class="text-sm text-zinc-600 dark:text-zinc-300 mb-5 leading-relaxed">
                            Connect your GitHub repositories to use as context for test cases, scripts, and more. Browse
                            files and create projects from repositories.
                        </p>
                        <div class="space-y-3">
            ...
            <div class="group relative h-full">
                <div
                    class="absolute -inset-1 bg-gradient-to-r from-teal-600 to-emerald-500 rounded-2xl blur opacity-10 group-hover:opacity-20 transition duration-1000">
                </div>
                <div
                    class="integration-card relative h-full bg-white dark:bg-zinc-900 rounded-2xl border-2 border-dashed border-zinc-300 dark:border-zinc-700 flex flex-col items-center justify-center p-6 text-center transition-all duration-300 hover:-translate-y-2 hover:border-zinc-400 dark:hover:border-zinc-600">
                    ...
                    <button
                        class="mt-4 text-sm text-teal-600 dark:text-teal-400 hover:text-teal-700 dark:hover:text-teal-300 flex items-center space-x-1 transition-colors">
    ...
    <script>
        ...
        function showDisconnectConfirm(service) {
            if (confirm(`Are you sure you want to disconnect ${service.charAt(0).toUpperCase() + service.slice(1)}?`)) {
                document.getElementById(`disconnect-${service}-form`).submit();
            }
        }
    </script>
@endpush
