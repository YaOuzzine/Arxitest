    ...
    <div class="container py-6">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="mb-8">
                ...
                <p class="text-zinc-600 dark:text-zinc-400">Import issues from Jira to create test suites, test cases, and
                    more.</p>
            </div>
            ...
            <form action="{{ route('integrations.jira.import.project') }}" method="POST" class="space-y-8">
                ...
                <div
                    ...
                    <div class="p-6">
                        <h2 class="text-xl font-semibold text-zinc-900 dark:text-white mb-4">
                            <span
                                class="inline-flex items-center justify-center w-8 h-8 rounded-full bg-blue-100 dark:bg-blue-900 text-blue-600 dark:text-blue-300 mr-2">1</span>
                            Select Jira Project
                        </h2>
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <select name="jira_project" id="jira_project"
                                    class="w-full rounded-lg border-zinc-300 dark:border-zinc-700 dark:bg-zinc-800 text-zinc-900 dark:text-white shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                    required>
                                    <option value="">Select a Jira project</option>
                                    @foreach ($jiraProjects as $project)
                                        <option
                                            value="{{ json_encode(['key' => $project['key'], 'name' => $project['name']]) }}">
                ...
                <div
                    ...
                    <div class="p-6">
                        <h2 class="text-xl font-semibold text-zinc-900 dark:text-white mb-4">
                            <span
                                class="inline-flex items-center justify-center w-8 h-8 rounded-full bg-blue-100 dark:bg-blue-900 text-blue-600 dark:text-blue-300 mr-2">2</span>
                            Select Destination
                        </h2>
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div
                                    class="relative border border-zinc-300 dark:border-zinc-600 rounded-lg p-4 hover:border-blue-500 dark:hover:border-blue-400 transition-colors duration-200">
                                    <input type="radio" name="create_new_project" id="create_new" value="1"
                                    ...
                                    <label for="create_new" class="block cursor-pointer">
                                        ...
                                        <p class="text-sm text-zinc-600 dark:text-zinc-400">Import into a brand new project
                                        </p>
                                    </label>
                                </div>
                                ...
                                <div
                                    class="relative border border-zinc-300 dark:border-zinc-600 rounded-lg p-4 hover:border-blue-500 dark:hover:border-blue-400 transition-colors duration-200">
                                    <input type="radio" name="create_new_project" id="existing_project" value="0"
                                        class="absolute top-4 right-4">
                                    <label for="existing_project" class="block cursor-pointer">
                                        <div class="font-medium text-zinc-900 dark:text-white mb-1">Use Existing Project
                                        </div>
                                        <p class="text-sm text-zinc-600 dark:text-zinc-400">Import into one of your projects
                                        </p>
                                    </label>
                                </div>
                            </div>
                            ...
                            <div id="new_project_container">
                                ...
                                <input type="text" name="new_project_name" id="new_project_name"
                                    class="w-full rounded-lg border-zinc-300 dark:border-zinc-700 dark:bg-zinc-800 text-zinc-900 dark:text-white shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                    placeholder="My Jira Import">
                            </div>

                            <!-- Existing Project Dropdown (Conditional) -->
                            <div id="existing_project_container" class="hidden">
                                <label for="arxitest_project_id"
                                    class="block text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-1">
                                    Select Project
                                </label>
                                <select name="arxitest_project_id" id="arxitest_project_id"
                                    class="w-full rounded-lg border-zinc-300 dark:border-zinc-700 dark:bg-zinc-800 text-zinc-900 dark:text-white shadow-sm focus:border-blue-500 focus:ring-blue-500">
                ...
                <div
                    ...
                    <div class="p-6">
                        <h2 class="text-xl font-semibold text-zinc-900 dark:text-white mb-4">
                            <span
                                class="inline-flex items-center justify-center w-8 h-8 rounded-full bg-blue-100 dark:bg-blue-900 text-blue-600 dark:text-blue-300 mr-2">3</span>
                            Configure Import
                        </h2>
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="space-y-2">
                                <div class="flex items-center">
                                    <input type="checkbox" name="import_epics" id="import_epics"
                                        class="rounded border-zinc-300 text-blue-600 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                        checked>
                                ...
                                <div class="flex items-center">
                                    <input type="checkbox" name="import_stories" id="import_stories"
                                        class="rounded border-zinc-300 text-blue-600 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                        checked>
                                ...
                                <div class="flex items-center">
                                    <input type="checkbox" name="generate_test_scripts" id="generate_test_scripts"
                                        class="rounded border-zinc-300 text-blue-600 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                    <label for="generate_test_scripts"
                            ...
                            <div class="pt-4">
                                <button type="button" id="toggle_advanced"
                                ...
                                <div id="advanced_options" class="hidden pt-4 space-y-4">
                                    <div>
                                        ...
                                        <input type="text" name="jql_filter" id="jql_filter"
                                            class="w-full rounded-lg border-zinc-300 dark:border-zinc-700 dark:bg-zinc-800 text-zinc-900 dark:text-white shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                            placeholder="status in (Open, 'In Progress')">
                                    ...
                                    <div>
                                        ...
                                        <input type="number" name="max_issues" id="max_issues" min="1"
                                            max="1000"
                                            class="w-full rounded-lg border-zinc-300 dark:border-zinc-700 dark:bg-zinc-800 text-zinc-900 dark:text-white shadow-sm focus:border-blue-500 focus:ring-blue-500"
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Form validation
            // Update your form validation code at the bottom of the script section
            const form = document.querySelector('form');
            form.addEventListener('submit', function(e) {
                // Prevent default submission temporarily for debugging
                e.preventDefault();
                ...
                if (!jiraProjectKey.value) {
                    valid = false;
                    errorMessages.push('Please select a Jira project');
                }

                // Validate new project name if creating new
                if (createNewRadio.checked && !newProjectName.value) {
                    valid = false;
                    errorMessages.push('Please enter a name for the new project');
                }
                ...
                if (!valid) {
                    ...
                    // For debugging, you can uncomment this to allow the form to submit
