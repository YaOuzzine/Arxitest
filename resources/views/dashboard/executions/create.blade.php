        ...
        <form action="{{ route('dashboard.executions.store') }}" method="POST">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <select id="script_id" name="script_id" class="w-full border-zinc-300 dark:border-zinc-700 rounded-lg shadow-sm dark:bg-zinc-800 text-zinc-900 dark:text-zinc-100 focus:ring-indigo-500 focus:border-indigo-500">
                ...
                <div>
                    ...
                    <select id="environment_id" name="environment_id" class="w-full border-zinc-300 dark:border-zinc-700 rounded-lg shadow-sm dark:bg-zinc-800 text-zinc-900 dark:text-zinc-100 focus:ring-indigo-500 focus:border-indigo-500">
