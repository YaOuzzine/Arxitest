...
@section('breadcrumbs')
    ...
    <li class="flex items-center">
        <i data-lucide="chevron-right" class="w-4 h-4 text-zinc-400 mx-1"></i>
        <span class="text-zinc-700 dark:text-zinc-300">Create Project</span>
    </li>
@endsection
...
<div class="h-full" x-data="{
    projectName: '',
    projectDescription: '',
    defaultFramework: 'selenium-python',
    ...
    submitForm() {
        if (!this.projectName.trim()) {
            ...
            this.notificationMessage = 'Project name is required';
            return;
        }
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between space-y-4 md:space-y-0">
            <div class="space-y-1">
                ...
                <p class="text-sm text-zinc-600 dark:text-zinc-400 transition-opacity duration-300">
                    Set up a new project to organize your test suites and test cases
                </p>
            </div>
            <div>
                <a href="{{ route('dashboard.projects') }}"
    ...
    <div class="bg-white/70 dark:bg-zinc-800/50 rounded-2xl shadow-2xl border border-zinc-200/50 dark:border-zinc-700/30 backdrop-blur-lg transition-all duration-300 hover:shadow-2xl">
        <div class="p-8">
            <form id="project-form" method="POST" action="{{ route('dashboard.projects.store') }}">
                @csrf
                        ...
                        <div class="sm:col-span-6 animate-fade-in-up delay-200">
                            <div class="relative">
                                <textarea id="description" name="description" rows="3"
                                          ...
                                          placeholder="A brief description of your project">{{ old('description') }}</textarea>
                    ...
                    <button type="button"
                        ...
                        <span class="relative z-10 flex items-center">
                            <span x-show="!isSubmitting" class="flex items-center">
                                Create Project
                                <i data-lucide="sparkles" class="w-4 h-4 ml-2"></i>
                            </span>
                            <span x-show="isSubmitting" class="flex items-center">
