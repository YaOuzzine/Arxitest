                    ...
                    <div class="p-6">
                        <div class="flex items-start justify-between">
                            ...
                            <div class="relative dropdown">
                                ...
                                <div class="dropdown-menu hidden absolute right-0 mt-1 z-10 w-48 py-1 bg-white dark:bg-zinc-800 rounded-md shadow-lg border border-zinc-200 dark:border-zinc-700">
