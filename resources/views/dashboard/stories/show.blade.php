    ...
    <div class="h-full space-y-6">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div class="flex flex-wrap gap-2">
                ...
                <form id="delete-form" action="{{ route('dashboard.stories.destroy', $story->id) }}" method="POST"
                    class="hidden">
                    @csrf
                    @method('DELETE')
                </form>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div
                    ...
                    <div
                        class="px-6 py-4 border-b border-zinc-200/50 dark:border-zinc-700/50 bg-zinc-50/30 dark:bg-zinc-800/30">
                    ...
                    <div class="p-6">
                        ...
                        @else
                            <div class="text-center p-6">
                                <div
                                    class="mx-auto w-12 h-12 rounded-full bg-zinc-100/50 dark:bg-zinc-700/20 flex items-center justify-center mb-3">
                ...
                <div
                    ...
                    <div class="p-6">
                        @if ($story->testCases->isNotEmpty())
                            <div class="space-y-4">
                                @foreach ($story->testCases as $testCase)
                                    <div
                                        class="group relative bg-zinc-50/30 dark:bg-zinc-700/20 p-4 rounded-xl border border-zinc-200/50 dark:border-zinc-700/50 hover:border-indigo-200/50 dark:hover:border-indigo-700/50 transition-all">
                                        <div class="flex items-start justify-between">
                                            <div class="flex-1 space-y-2">
                                                {{-- Title and link into the test-case show page --}}
                                                ...
                                                {{-- Project and (optional) Suite breadcrumbs --}}
                                                <div class="flex flex-wrap gap-3 text-sm">
                                                    <a href="{{ route('dashboard.projects.show', $testCase->project_id) }}"
            ...
            <div class="space-y-6">
                    ...
                    <div class="p-6">
                        <dl class="divide-y divide-zinc-200/50 dark:divide-zinc-700/50">
                            ...
                            @if ($story->external_id)
                                <div class="py-3 sm:grid sm:grid-cols-3 sm:gap-4">
                                    <dt
                                        class="text-sm font-medium text-zinc-500 dark:text-zinc-400 flex items-center gap-1">
                                ...
                                @foreach ($story->metadata as $key => $value)
                                    @if (!is_array($value) && !is_object($value))
                                        <div class="py-3 sm:grid sm:grid-cols-3 sm:gap-4">
                                            ...
                                            <dd
                                                class="mt-1 text-sm text-zinc-900 dark:text-white sm:mt-0 sm:col-span-2 break-words">
                                                {{ $value }}
                                            </dd>
                                        </div>
                                    @endif
                ...
                <div
                    ...
                    <div class="p-6 space-y-3">
                        ...
                        <!-- View Test Cases (only if there are any) -->
                        @if ($story->testCases->isNotEmpty())
                            @php
                                // Use the accessor you added on the TestCase model
