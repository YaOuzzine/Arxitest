                     ...
                     <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                         ...
                         <div class="mt-2">
                             <p class="text-sm text-zinc-600 dark:text-zinc-400">
                                 Are you sure you want to delete the test case "<strong class="font-semibold text-zinc-700 dark:text-zinc-200" x-text="deleteCaseTitle"></strong>"? This action cannot be undone.
                             </p>
                         </div>
                    </div>
                </div>
