            ...
            <div
                ...
                <div class="p-8">
                    <div class="text-center mb-8">
                        ...
                        <p class="text-zinc-600 dark:text-zinc-400">Join Arxitest to start testing smarter</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('register.email') }}" class="auth-form space-y-6"
                        x-data="{ processing: false }">
                        @csrf

                        @if (request()->has('invitation') || session('invitation_token'))
                            <input type="hidden" name="invitation_token"
                                value="{{ request()->query('invitation') ?? session('invitation_token') }}">
                        @endif
