...
return [
    ...
    'docker_images' => [
        'selenium_python' => env('TEST_DOCKER_IMAGE_SELENIUM_PYTHON', 'youzzine/arxitest-selenium-python:latest'),
        'cypress' => env('TEST_DOCKER_IMAGE_CYPRESS', 'youzzine/arxitest-cypress:latest'),
